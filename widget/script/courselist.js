...
export const aboutus = [
    {
        "value": "<p>重拾梦想，享受追梦的过程，因为追梦本身就是一种成长。我不知道坚持下去能否成功，但是我知道不坚持就会一无所有。不是所有的梦想都能实现，但是实现梦想的过程对自己来说是一种历练、一种提升，在这期间磨练的技能也会在未来的某一刻派上用场。</p>\n<p>如果不愿沉溺于现实的安逸，那就做一只跳出温水的青蛙。余生未可知，庸庸碌碌也好、奋起直追也好，愿你不要辜负似水流年。</p>"
    }
]
